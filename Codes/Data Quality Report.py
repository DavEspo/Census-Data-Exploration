...
# Displays the featuresValues csv file which is the festures csv file but after filling in the information for the data characteristics
features_df = pd.read_csv('./featuresValues.csv', index_col ='col_name')
print("\n\nFeatures Values DataFrame:\n",features_df)


# The rest of this code is a Data Quality Report for Continuous and Categorical features which include Bar Plots(Categorical) and Histograms(Continuous)
# DataFrame for Continuous Features
# The Continuous Features DataFrame includes feature, description, count, % of missing, cardinality, minimum, Q1, median, Q3, maximum, mean, and standard deviation
...
# The Categorical Features DataFrame includes feature, description, count, % of missing, cardinality, mode, mode frequency, mode %, 2nd mode, 2nd mode frequency, and 2nd mode %
